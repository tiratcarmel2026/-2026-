...
require TC_CORE_DIR . 'includes/cpt-departments.php';
require TC_CORE_DIR . 'includes/cpt-protocols.php';
require TC_CORE_DIR . 'includes/cpt-shelters.php';
...
function tc_core_activate() {
	...
	require_once TC_CORE_DIR . 'includes/cpt-departments.php';
	require_once TC_CORE_DIR . 'includes/cpt-protocols.php';
	require_once TC_CORE_DIR . 'includes/cpt-shelters.php';
	...
	tc_core_register_department_cpt();
	tc_core_register_protocol_cpt();
	tc_core_register_shelter_cpt();
